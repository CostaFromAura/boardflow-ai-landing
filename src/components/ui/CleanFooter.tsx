    ...
    <footer className="bg-black py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center">
          ...
          {/* Message button as a link to Twitter */}
          <div className="mb-12">
            <a
              href="https://x.com/boardflowai"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative max-w-md mx-auto border border-gray-600 rounded-full px-6 py-3 bg-transparent hover:border-blue-400 transition-colors flex items-center justify-between w-80"
            >
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-16">
            ...
            <div>
              ...
              <p className="text-gray-400">@boardflowai</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm">© 2025 BoardFlow.ai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
